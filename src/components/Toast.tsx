...
export function Toast({ message, type, onClose }: ToastProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-slide-in-right">
      ...
      >
        {type === 'success' ? (
          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-green-500 shadow-md shadow-emerald-500/40">
            <CheckCircle className="h-4 w-4 text-white" />
          </div>
        ) : (
          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-red-400 to-rose-500 shadow-md shadow-red-500/40">
